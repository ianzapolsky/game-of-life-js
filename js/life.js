...
var life = (function () {
  ...
  step = function () {
    ...
    // update the number of simulated time units
    cur_y = parseInt(year.html());
    year.html(cur_y+1);

    // update the number of dead and cells
    cur_d = parseInt(dead.html());
    dead.html(cur_d+nextDead.length);
    cur_b = parseInt(born.html());
    born.html(cur_b+nextAlive.length);
